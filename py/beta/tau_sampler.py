        ...
        return {
            "required": {
                ...
                "seed":         ("INT",   {"default": 0,   "min": -2,     "max": 0xffffffffffffffff,
                                           "tooltip": "Noise seed. -2 is the legacy magic value for latent-as-noise dispatch under latent_role=auto (deprecated -- set latent_role explicitly for that). Otherwise the seed drives both initial and per-step noise."}),
